...
class Backend extends CI_Controller
{
	...
	{		
		...
		if ($this->input->post('add'))
		{
			...
			$roleParent = $this->input->post('role_parent');
			if(ctype_space($roleName) || $roleName == ""){
				$data['input_message'] = "Please input Role Name";
			} else{
				$data['input_message'] = "Successfully added Role";
				$this->roles->create_role($roleName, $roleParent);
			}
		}
	...
	function custom_permissions()
	{
		...
		if ($this->input->post('save'))
		{
			...
			$permission_data['visitPccwSolution'] = $this->input->post('visitPccwSolution');
			$permission_data['visitHaPortalApp'] = $this->input->post('visitHaPortalApp');
			$permission_data['visitDev'] = $this->input->post('visitDev');
			$permission_data['visitRecordControl'] = $this->input->post('visitRecordControl');
			$permission_data['visitDigitalAsset'] = $this->input->post('visitDigitalAsset');
			$permission_data['visitAdministrator'] = $this->input->post('visitAdministrator');
			$permission_data['edit'] = $this->input->post('edit');
			$permission_data['delete'] = $this->input->post('delete');
			$permission_data['approveAndReject'] = $this->input->post('approveAndReject');
		...
		$data['visitPccwSolution'] = $this->permissions->get_permission_value($role_id, 'visitPccwSolution');
		$data['visitHaPortalApp'] = $this->permissions->get_permission_value($role_id, 'visitHaPortalApp');
		$data['visitDev'] = $this->permissions->get_permission_value($role_id, 'visitDev');
		$data['visitRecordControl'] = $this->permissions->get_permission_value($role_id, 'visitRecordControl');
		$data['visitDigitalAsset'] = $this->permissions->get_permission_value($role_id, 'visitDigitalAsset');
		$data['visitAdministrator'] = $this->permissions->get_permission_value($role_id, 'visitAdministrator');
		...
		$data['approveAndReject'] = $this->permissions->get_permission_value($role_id, 'approveAndReject');
